...
class RegistrationControllerTest extends WebTestCase
{
    ...
    public function testRegister(): void
    {
        ...
        self::assertEmailAddressContains($messages[0], 'from', 'Admin@sortir.com');
        ...
        self::assertTrue(static::getContainer()->get(UtilisateurRepository::class)->findAll()[0]->isVerified());
    }
}
